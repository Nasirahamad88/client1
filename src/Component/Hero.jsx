...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col-reverse md:flex-row items-center w-[90%] mx-auto gap-10 md:gap-28 py-10 md:py-20">
      {/* Video Section */}
      ...
      <div className="w-full md:w-1/2 text-center md:text-left">
        <h1 className="text-4xl pb-5 font-extrabold text-white">
          Boost the{" "}
          <span className="hearts"></span>
          <span className="animated-word text-orange">{words[currentWordIndex]}</span><br/> of
          your content
        </h1>
        <p className="text-base pb-7 md:text-xl text-white py-3 md:py-5">
